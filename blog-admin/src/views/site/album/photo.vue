  ...
  <div class="app-container">
    <el-card class="main-card">
      ...
      <el-dialog center :title="title" :visible.sync="dialogVisible" width="35%">
        <el-form ref="dataForm" :rules="rules" label-width="80px" size="medium" :model="photoForm">
          <el-form-item label="照片名称" prop="name">
            <el-input v-model="photoForm.name" style="width:220px" />
          </el-form-item>
          <el-form-item label="照片描述" prop="info">
            <el-input v-model="photoForm.info" style="width:220px" />
          </el-form-item>
          <el-form-item label="照片" prop="url">
            ...
            >
              <i v-if="photoForm.url === ''" class="el-icon-upload" />
              <div v-if="photoForm.url === ''" class="el-upload__text">
