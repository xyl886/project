...
public class UserController {
    ...
    @SaCheckLogin
    @ApiOperation(value = "查看在线用户", httpMethod = "GET", response = Result.class, notes = "查看在线用户")
    public Result listOnlineUsers(String keywords) {
    ...
    @ApiOperation(value = "踢人下线", httpMethod = "GET", response = Result.class, notes = "踢人下线")
    public Result kick(String token) {
