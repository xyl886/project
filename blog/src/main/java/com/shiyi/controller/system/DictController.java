...
public class DictController {
    ...
    @SaCheckLogin
    @ApiOperation(value = "字典类型列表", httpMethod = "GET", response = Result.class, notes = "字典类型列表")
    public Result list(String name, Integer isPublish, String descColumn, String ascColumn){
        return dictService.listDict(name,isPublish,descColumn,ascColumn);
    }

    @RequestMapping(value = "/add",method = RequestMethod.POST)
    @SaCheckPermission("/system/dict/add")
    @ApiOperation(value = "添加字典", httpMethod = "POST", response = Result.class, notes = "添加字典")
    ...
    @ApiOperation(value = "修改字典", httpMethod = "POST", response = Result.class, notes = "修改字典")
    ...
    @ApiOperation(value = "删除字典", httpMethod = "DELETE", response = Result.class, notes = "删除字典")
    ...
    @ApiOperation(value = "批量删除字典", httpMethod = "DELETE", response = Result.class, notes = "批量删除字典")
