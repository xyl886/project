...
public class SystemConfigController {
    ...
    @SaCheckLogin
    @ApiOperation(value = "查询系统配置", httpMethod = "GET", response = Result.class, notes = "查询系统配置")
    ...
    @ApiOperation(value = "修改系统配置", httpMethod = "POST", response = Result.class, notes = "修改系统配置")
